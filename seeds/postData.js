...
const postData =[
  {
    ...
    "text": "You will find that cafes and shops are more expensive the closer they are to the main attractions such as the Eiffel Tower and the Triumph Arch. Walk a few blocks from the main areas to find more authentic and less expensive establishments!",
    "traveller_id": 1
  },
  {
